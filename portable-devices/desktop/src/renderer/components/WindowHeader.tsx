	...
	render() {
		return (
			<div
				...
				onDoubleClick={this.handleWindowToggleMaximize}
			>
				<div className='window-header-controls'>
					<div
						className={`btn ${this.props.close ? 'close' : 'disabled'}`}
						onClick={this.handleWindowClose}
					/>
					<div
						className={`btn ${this.props.minimize ? 'minimize' : 'disabled'}`}
						onClick={this.handleWindowMinimize}
					/>
					<div
						className={`btn ${this.props.maximize ? 'maximize' : 'disabled'}`}
						onClick={this.handleWindowToggleMaximize}
					/>
				</div>
