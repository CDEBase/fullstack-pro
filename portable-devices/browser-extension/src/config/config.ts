...
export const config = envalid.cleanEnv(process.env, {
    ...
    BACKEND_URL: str({ default: __BACKEND_URL__ }),
    LOCAL_BACKEND_URL: str({ default: __BACKEND_URL__ }),
    LOCAL_GRAPHQL_URL: str({ default: __GRAPHQL_URL__ }),
    GRAPHQL_URL: str({ default: __GRAPHQL_URL__ }),
    CLIENT_URL: str({ default: __BACKEND_URL__ }),
