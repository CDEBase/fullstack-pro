...
>;
export type AddCounterStateComponentProps = Omit<
...
export const AddCounterStateComponent = (
	props: AddCounterStateComponentProps
) => (
...
export type AddCounterStateMutationResult =
	Apollo.MutationResult<SchemaTypes.AddCounterStateMutation>;
...
>;
export type AddCounterComponentProps = Omit<
	ApolloReactComponents.MutationComponentOptions<
		SchemaTypes.AddCounterMutation,
		SchemaTypes.AddCounterMutationVariables
	>,
...
>;
export type AddCounter_WsComponentProps = Omit<
	ApolloReactComponents.MutationComponentOptions<
		SchemaTypes.AddCounter_WsMutation,
		SchemaTypes.AddCounter_WsMutationVariables
	>,
...
export const AddCounter_WsComponent = (props: AddCounter_WsComponentProps) => (
	<ApolloReactComponents.Mutation<
		...
		SchemaTypes.AddCounter_WsMutationVariables
	>
		mutation={AddCounter_WsDocument}
		{...props}
	/>
);
...
export type AddCounter_WsMutationResult =
	Apollo.MutationResult<SchemaTypes.AddCounter_WsMutation>;
...
>;
export type SyncCachedCounterComponentProps = Omit<
	ApolloReactComponents.MutationComponentOptions<
		SchemaTypes.SyncCachedCounterMutation,
		SchemaTypes.SyncCachedCounterMutationVariables
	>,
...
export const SyncCachedCounterComponent = (
	props: SyncCachedCounterComponentProps
) => (
	<ApolloReactComponents.Mutation<
		SchemaTypes.SyncCachedCounterMutation,
		SchemaTypes.SyncCachedCounterMutationVariables
	>
		mutation={SyncCachedCounterDocument}
		{...props}
	/>
);
...
export type SyncCachedCounterMutationResult =
	Apollo.MutationResult<SchemaTypes.SyncCachedCounterMutation>;
...
`;
export type CounterCacheQueryComponentProps = Omit<
...
export const CounterCacheQueryComponent = (
	props: CounterCacheQueryComponentProps
) => (
	<ApolloReactComponents.Query<
		SchemaTypes.CounterCacheQueryQuery,
		SchemaTypes.CounterCacheQueryQueryVariables
	>
		query={CounterCacheQueryDocument}
		{...props}
	/>
);
...
`;
export type CounterStateComponentProps = Omit<
	ApolloReactComponents.QueryComponentOptions<
...
`;
export type CounterQueryComponentProps = Omit<
	ApolloReactComponents.QueryComponentOptions<
...
`;
export type OnCounterUpdatedComponentProps = Omit<
...
export const OnCounterUpdatedComponent = (
	props: OnCounterUpdatedComponentProps
) => (
...
export type OnCounterUpdatedSubscriptionResult =
	Apollo.SubscriptionResult<SchemaTypes.OnCounterUpdatedSubscription>;
